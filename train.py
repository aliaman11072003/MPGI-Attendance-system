...
message = tk.Label(window, text="MAHARANA PRATAP ENGINEERING COLLEGE (Facial-Recognition-Based-Attendance-System)" ,bg="Green"  ,fg="white"  ,width=80  ,height=3,font=('times', 20, 'italic bold underline')) 
